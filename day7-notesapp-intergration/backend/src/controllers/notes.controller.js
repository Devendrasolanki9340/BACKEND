...
// Update note controller PATCH

const singleEntityUpdatedController = async (req, res)=>{
    try {
        let noteId = req.params.id;
        let body = req.body
...
module.exports = { createNotesController, getAllNotesController, getSingleNoteController, updateNoteController,singleEntityUpdatedController,deleteNotesController };
